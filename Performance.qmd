...
We then created three structural variables related to course level:
...
This is a binary column in which 1 represents a passing of the course and 0 means the student passed, failed or withdrew. This is done in first case when call in the above code.

&bull; **Numeric Grade (grade_numeric)**

This column describes the corresponding numeric grade to the letter grade. This is done in second case when call in the above code.
